...
config.notificationColor = color.LightSkyBlue --The color of the chat notification
...
FossMail.OnPlayerAuth = function(eventStatus, pid)
  return loginNotify(pid)
end
...
customEventHooks.registerHandler("OnPlayerAuthentified", FossMail.OnPlayerAuth)
