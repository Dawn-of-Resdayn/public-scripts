...
local function doRoll(pid, playerName, rollcheck)
    ...
    if rollCheckID ~= 27 then
        ...
        if rpchat ~= nil then playerName = rpchat.getName(pid) end

        message = color.Orange .. "[ROLL] " .. color.White .. playerName .. " rolled " .. color.Cyan .. roll .. color.White .. " on " .. color.Cyan .. rollcheck .. color.White .. " check.\n" .. color.Default
    	...
    	tes3mp.SendMessage(pid, color.Cyan ..  "[RP-Rolls]: " .. color.White .. "Invalid skill.\n", false)
    end
end
